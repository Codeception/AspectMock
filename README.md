...
* `excludePaths` a paths in which PHP files should not be affected by aspects. You should exclude AspectMock library and Go Aop framework from the aspect hooking.
...
$kernel->init([
    ...
    'cacheDir'  => '/tmp/myapp',
    'includePaths' => [__DIR__.'/../src']
    'excludePaths' => [__DIR__.'/../../vendor', __DIR__]
]);
?>
```
